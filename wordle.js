...
var listaPalabras = ['ajito', 'ayuda', 'adobo', 'adora', 'apilo', 'añejo','messi','ramos','pogba','anuel'];
...
function haGanado() {
    ...
    if (palabra == palabraBuscada){
        puntos = puntos + 10;
        $("#puntos").text(puntos)
        let mensajeGanador = '<h2 class="alert alert-success text-center" role="alert">Felicidades crack, has ganado';
...
function haPerdido(){
    ...
    let mensajePerdedor = '<h2 class="alert alert-warning text-center" role="alert">Has perdido, no tienes más intentos';
